...
function inputHandlers(bar1, bar2) {
  document.addEventListener("keydown", (event) => {
    if (event.key == "w") bar1.yPos -= 40;
    if (event.key == "s") bar1.yPos += 40;
    //if (event.key == "a") bar1.xPos -= 30;
    //if (event.key == "d") bar1.xPos += 30;
    if (event.key == "u") bar2.yPos -= 40;
    if (event.key == "j") bar2.yPos += 40;
    //if (event.key == "h") bar2.xPos -= 30;
    //if (event.key == "k") bar2.xPos += 30;
